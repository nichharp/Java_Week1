...
public class Paint {
	...
	public void calculate(double floorArea) {
		...
		double tinsOfCheapo = Math.ceil(floorArea/(10*20)); double moneyForCheapo = tinsOfCheapo*19.99;
		double tinsOfAverage = Math.ceil(floorArea/(11*15)); double moneyForAverage = tinsOfAverage*17.99;
		double tinsOfDulux = Math.ceil(floorArea/(20*10)); double moneyForDulux = tinsOfDulux*25.00;
		
//		System.out.println(tinsOfCheapo );
//		System.out.println(tinsOfAverage);
//		System.out.println(tinsOfDulux);
		
		double wasteCheapo = (tinsOfCheapo*20*10-floorArea)/10; //work out the number of litres wasted of Cheapo
		double wasteAverage = (tinsOfAverage*15*11-floorArea)/11;		
		double wasteDulux = (tinsOfDulux*10*20-floorArea)/20; 		
